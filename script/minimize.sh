...
apt-get -y purge xorg-dev #libx11-data xauth libxmuu1 libxcb1 libxext6 
echo "==> Removing other oddities"
apt-get -y purge popularity-contest installation-report landscape-common wireless-tools wpasupplicant ubuntu-serverguide ncurses-dev nano
